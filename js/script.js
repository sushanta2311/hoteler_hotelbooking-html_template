...
(function($) {
	...
	//testimonial-carousel Two
	if ($('.testimonial-carousel-hiking-l2').length) {
	   $('.testimonial-carousel-hiking-l2').slick({
		    infinite: true,
			speed: 300,
			slidesToShow: 4,
			slidesToScroll: 1,
	...
	//testimonial-carousel city
	if ($('.testimonial-carousel-city').length) {
	   $('.testimonial-carousel-city').slick({
		    infinite: true,
			speed: 300,
			slidesToShow: 4,
			slidesToScroll: 1,
	...
	//testimonial-carousel city
	if ($('.testimonial-carousel-lodge').length) {
	   $('.testimonial-carousel-lodge').slick({
		    infinite: true,
			speed: 300,
			slidesToShow: 3,
			slidesToScroll: 1,
	...
	//service-carousel Three
	if ($('.room-service-carousel-golf').length) {
		var swiper = new Swiper(".room-service-carousel-golf", {
			slidesPerView: 1,
			spaceBetween: 30,
			navigation: {
	            nextEl: '.swiper-button-next',
	...
	//service-carousel Three
	if ($('.countryside-h01-carousel').length) {
		var swiper = new Swiper(".countryside-h01-carousel", {
			slidesPerView: 4,
			spaceBetween: 30,
			navigation: {
	            nextEl: '.swiper-button-next',
	...
	//service-carousel Two
	if ($('.service-two-slider-two').length) {
	   $('.service-two-slider-two').slick({
		    infinite: true,
			speed: 300,
			slidesToShow: 3,
			slidesToScroll: 1,
	...
	var thumbs_rd = new Swiper('.rdetails-thumbs', {
		slidesPerView: 'auto',
		spaceBetween: 10,
		centeredSlides: true,
		loop: true,
	...
	var slider_rd = new Swiper('.room-details-slider-content', {
		slidesPerView: 1,
		centeredSlides: true,
		loop: true,
		loopedSlides: 3,
